...
$emp = $conn->query("SELECT * FROM employees WHERE company_id = $company_id AND id=$employee_id")->fetch_assoc();
...
<html lang="en">
  ...
  <head>
    ...
    <title>AIMIS | Employee Profile</title>
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="../payslips/my_payslip">Payslips</a>
                                        <span class="badge badge-info">Payslip History</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="../attendance/view_attendance.php">Attendance Records</a>
                                        <span class="badge badge-secondary">Timesheets</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="../leave/view_leave.php">Leave Applications</a>
                                        <span class="badge badge-warning">Leave History</span>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a href="../contracts/view_contract.php">Contract Details</a>
