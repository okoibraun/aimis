...
$payslips = $conn->query("SELECT * FROM payroll");
?>
<!doctype html>
<html lang="en">
  <!--begin::Head-->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php foreach ($payslips as $payroll): ?>
                      <tr>
                        ...
                        <td>
                          <a href="pay_slip_view.php?payroll_id=<?= $payroll['id'] ?>" class="btn btn-info">View Pay Slip</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
