            ...
            <section class="content">
                <form action="<?= $form_action ?>" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="lead_id" class="form-control" value="<?= $quotation['lead_id'] ?? '' ?>">
                        </div>

                        <div class="form-group">
                        <label>Quote Date</label>
                        <input type="date" name="quote_date" class="form-control" value="<?= $quotation['quote_date'] ?? date('Y-m-d') ?>">
                        </div>

                        <div class="form-group">
                            <label>Expiry Date</label>
                            <input type="date" name="expiry_date" class="form-control" value="<?= $quotation['expiry_date'] ?? '' ?>">
                        </div>
