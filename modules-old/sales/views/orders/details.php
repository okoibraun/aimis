                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            ...
                            <a href="orders.php?action=form&id=<?= $order['id'] ?>" class="btn btn-warning">Edit</a>
                            <a href="orders.php?action=pdf&id=<?= $order['id'] ?>" class="btn btn-info">Generate PDF</a>
                            <a href="orders.php?action=sign&id=<?= $order['id'] ?>" class="btn btn-success">Digital Sign</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
