...
$result = $conn->query("SELECT * FROM crm_segments WHERE company_id = $company_id");
?>
<!doctype html>
<html lang="en">
  <!--begin::Head-->
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-lg-6 text-end">
                      <a href="add.php" class="btn btn-success btn-sm">+ New Segment</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
