    ...
    <div class="app-wrapper">
      ...
      <div class="app-content">
        <div class="container-fluid">
          ...
          <div class="content-wrapper" style="min-height: 875.2px;">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <div class="card-body p-0">
                                        <ul class="list products-list product-list-in-card pl-2 pr-2">
                                            <li class="list-item">
                                                ...
                                                <div class="product-info">
                                                    <a href="javascript:void(0)" class="product-title">Samsung TV
                                                        <span class="text text-warning float-end">$1800</span>
                                                    </a>
