...
$id = $_GET['id'] ?? null;
$customer = $conn->query("SELECT * FROM sales_customers WHERE company_id = $company_id AND id = $id")->fetch_assoc();
$message = '';
if (!$customer) {
      ...
      <div class="app-content">
        <div class="container-fluid">
            ...
            <section class="content-header mt-3 mb-3">
                <h1><?= ($customer['customer_type'] == "lead") ? "Lead" : "Customer" ?> Details: <?= $customer['name'] ?></h1>
            </section>
                    ...
                    <div class="col-3">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title"><?= ($customer['customer_type'] == "lead") ? "Lead" : "Customer" ?> Info</h3>
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Address:</strong> <?= !empty($customer['address']) ? nl2br($customer['address']) : '' ?></p>
                            ...
                            <div class="card-body">
                              <table class="table table-hover table-striped DataTable">
                                ...
                                <tbody>
                                  ...
                                  <?php $invoices = $conn->query("SELECT * FROM sales_invoices WHERE company_id = $company_id AND customer_id = $customer_id"); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped DataTable">
                                    ...
                                    <tbody>
                                        <?php $orders = $conn->query("SELECT * FROM sales_orders WHERE company_id = $company_id AND customer_id = $customer_id"); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../orders/order.php?id=<?= $order['id']; ?>" target="_blank" class="btn btn-info btn-sm">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <tbody>
                                    <?php $quotations = $conn->query("SELECT * FROM sales_quotations WHERE company_id = $company_id AND customer_id = $customer_id"); ?>
