        ...
        <div class="container-fluid">
            ...
            <div class="content-wrapper">
              <!-- <section class="content-header">
                <h1><i class="fas fa-globe"></i> Country-Specific Tax Templates & BEPS Compliance</h1>
                      ...
                      <tbody>
                        <?php foreach ($rules as $i => $r): ?>
                          <tr>
                            ...
                            <td><?= $r['updated_at'] ?></td>
                            <td>
                              <button class="btn btn-sm btn-info editRuleBtn"
                                      data-id="<?= $r['id'] ?>"
                                      data-country="<?= $r['country'] ?>"
                                      data-template="<?= $r['template_name'] ?>"
                                      data-beps="<?= $r['beps_compliant'] ?>"
                                      data-active="<?= $r['is_active'] ?>"
                                      data-toggle="modal" data-target="#ruleModal">
                                Edit
                              </button>
                              <a href="ajax/delete_rule.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this rule?')">Delete</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      </tbody>
