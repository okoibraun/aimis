...
$fund = $conn->query("SELECT * FROM tax_funds WHERE id = $id AND company_id = $company_id")->fetch_assoc();
?>
<!doctype html>
<html lang="en">
  <!--begin::Head-->
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="save.php" method="POST" id="fundForm" class="card">
                        <input type="hidden" name="id" id="fund_id" value="<?= $id ? $id : '' ?>">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="fund_code" id="fund_code" class="form-control" value="<?= $fund['fund_code'] ?>" readonly required>
                            </div>
                            <div class="form-group">
                                <label>Fund Name</label>
                                <input type="text" name="fund_name" id="fund_name" class="form-control" value="<?= $fund['fund_name'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Opening Balance</label>
                                <input type="number" name="balance" id="fund_balance" class="form-control" step="0.01" value="<?= $fund['balance'] ?>" required>
                            </div>
                        </div>
