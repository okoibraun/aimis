...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $quote_stmt = $conn->prepare("UPDATE sales_quotations SET lead_id=?, company_id=?, customer_id=?, quote_number=?, quotation_date=?, valid_until=?, status=?, total=?, tax=?, created_by=?, notes=? WHERE id=?");
            $quote_stmt->bind_param("iiissssddisi", $lead_id, $company_id, $customer_id, $quote_number, $quotation_date, $valid_until, $status, $total, $tax_amount, $created_by, $notes, $id);
    $quote_stmt->execute();
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-8">
                                <div class="form-group">
                                    <label>Tax (N)</label>
                                    <input type="number" step="0.01" name="tax" class="form-control" value="<?= $quotation['tax'] ?? '0.00' ?>">
                                </div>
                                <div class="form-group">
                                    <label>Total (N)</label>
                                    <input type="number" step="0.01" name="total" class="form-control" id="total" readonly value="<?= $quotation['total'] ?? '0.00' ?>">
                                </div>
                            </div>
                        </div>
