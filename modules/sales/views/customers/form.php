      ...
      <div class="app-content">
        <div class="container-fluid">
            ...
            <section class="content">
                <form action="../../../modules/sales/controllers/customers.php" method="POST">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name" class="form-control" value="<?= htmlspecialchars($customer['company_name']) ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
