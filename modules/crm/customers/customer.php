...
$id = $_GET['id'] ?? null;
$customer = $conn->query("SELECT * FROM sales_customers WHERE company_id = $company_id AND customer_type = 'customer'")->fetch_assoc();
$message = '';
if (!$customer) {
                    ...
                    <div class="col-3">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Address:</strong> <?= nl2br($customer['address']) ?></p>
