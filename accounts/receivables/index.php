...
$customers = mysqli_query($conn, "SELECT id, name FROM sales_customers WHERE company_id = $company_id ORDER BY name");
?>
<!doctype html>
<html lang="en">
  <!--begin::Head-->
  <head>
    ...
    <title>AIMIS | Account Receivable</title>
          ...
          <section class="content">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form method="get" class="form-inline align-item-center">
                      <div class="row mb-2">
                        <div class="col-lg-2">
                  ...
                  <?php } ?>
                  <table class="table table-bordered table-hover DataTable mt-3">
                    <thead>
                      <tr>
                        <th>Invoice No</th>
                        <th>Customer</th>
